...
public class StatisticsDriver {
	...
	public static void level_1(){
		...
		double numOfRandom = 1e5; //change number of tries
	...
	public static void level_2(){
		...
		decisionTree.add(new Leaf(10, 5, 10));
		int sigmaTries = 200;
		...
		double numOfPseudoExperiments = 1e2; //change number of pseudoExperiments
	...
	public static void level_3(){
		...
		int sigmaTries = 200;
		double sigmaIncrement = 0.01;
		double triesPerLeaf = 1e4; //change tries
		PoissonDistribution potentialPoisson = new PoissonDistribution();
	...
	public static void challenge(){
		...
		potentialPoisson.setBackgroundUncertainty(0.2);
		double trueSigma = 0;
		double numOfPseudoExperiments = 1e7; //change number of pseudoExperiments
