...
abstract public class Animal implements Drawable {
	...
	abstract protected double getSpotValue();
	...
	public double distance(Animal ani) {
		double deltaX = ani.getCell().getX() - getCell().getX();
		double deltaY = ani.getCell().getY() - getCell().getY();
